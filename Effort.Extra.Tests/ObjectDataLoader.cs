    ...
    internal class ObjectDataLoader
    {
        public class Ctor
        {
            ...
            public abstract class ctor_context : WithFakes
            {
                ...
                protected static Extra.ObjectDataLoader subject;

                Because of = () => thrown_exception = Catch.Exception(
                    () => subject = new Extra.ObjectDataLoader(data));
            }
        ...
        public class CreateTableDataLoaderFactory
        {
            ...
            public abstract class create_table_data_loader_factory_context : WithSubject<Extra.ObjectDataLoader>
            {
                protected static Exception thrown_exception;
                protected static Extra.ObjectData data;

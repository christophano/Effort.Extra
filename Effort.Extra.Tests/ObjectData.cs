...
namespace Effort.Extra.Tests
{
    ...
    internal class ObjectData
    {
        ...
        public class HasTable
        {
            ...
            public abstract class has_table_context : WithSubject<Extra.ObjectData>
            {
                protected static Exception thrown_exception;
                protected static string table_name;
        ...
        public class TableType
        {
            ...
            public abstract class table_type_context : WithSubject<Extra.ObjectData>
            {
                protected static Exception thrown_exception;
                protected static string table_name;
        ...
        public class GetTable
        {
            ...
            public abstract class get_table_context : WithSubject<Extra.ObjectData>
            {
                protected static Exception thrown_exception;
                protected static string table_name;
